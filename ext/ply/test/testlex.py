...
def pymodule_out_exists(filename, optimization=None):
    return os.path.exists(
        make_pymodule_path(filename, optimization=optimization)
    )
...
class LexErrorWarningTests(unittest.TestCase):
    ...
    def test_lex_error2(self):
        ...
        self.assert_(
            check_expected(
                result, "Rule 't_error' must be defined as a function\n"
            )
        )
    ...
    def test_lex_ignore2(self):
        ...
        self.assert_(
            check_expected(
                result, "t_ignore contains a literal backslash '\\'\n"
            )
        )
    ...
    def test_lex_re3(self):
        ...
        if sys.hexversion < 0x3050000:
            ...
            msg = (
                "Invalid regular expression for rule 't_POUND'. missing ), unterminated subpattern at position 0\n"
    ...
    def test_lex_rule1(self):
        ...
        self.assert_(
            check_expected(
                result, "t_NUMBER not defined as a function or string\n"
            )
        )
    ...
    def test_lex_state1(self):
        ...
        self.assert_(
            check_expected(
                result, "states must be defined as a tuple or list\n"
            )
        )
    ...
    def test_lex_state5(self):
        ...
        result = sys.stderr.getvalue()
        self.assert_(
            check_expected(result, "State 'comment' already defined\n")
        )
    ...
    def test_lex_state_norule(self):
        ...
        result = sys.stderr.getvalue()
        self.assert_(
            check_expected(result, "No rules defined for state 'example'\n")
        )
    ...
    def test_lex_token5(self):
        ...
        self.assert_(
            check_expected(
                str(e),
                "lex_token5.py:19: Rule 't_NUMBER' returned an unknown token type 'NUM'",
            )
        )
    ...
    def test_lex_token_dup(self):
        ...
        result = sys.stderr.getvalue()
        self.assert_(
            check_expected(result, "Token 'MINUS' multiply defined\n")
        )
    ...
    def test_lex_literal1(self):
        ...
        self.assert_(
            check_expected(
                result, "Invalid literal '**'. Must be a single character\n"
            )
        )
...
class LexBuildOptionTests(unittest.TestCase):
    ...
    def test_lex_optimize(self):
        ...
        p = subprocess.Popen(
            [sys.executable, "-O", "lex_optimize.py"], stdout=subprocess.PIPE
        )
        ...
        p = subprocess.Popen(
            [sys.executable, "-OO", "lex_optimize.py"], stdout=subprocess.PIPE
        )
        result = p.stdout.read()
        self.assert_(
            check_expected(
    ...
    def test_lex_optimize2(self):
        ...
        p = subprocess.Popen(
            [sys.executable, "-O", "lex_optimize2.py"], stdout=subprocess.PIPE
        )
        result = p.stdout.read()
        self.assert_(
            check_expected(
        ...
        p = subprocess.Popen(
            [sys.executable, "-OO", "lex_optimize2.py"], stdout=subprocess.PIPE
        )
        result = p.stdout.read()
        self.assert_(
            check_expected(
    ...
    def test_lex_optimize3(self):
        ...
        p = subprocess.Popen(
            [sys.executable, "-O", "lex_optimize3.py"], stdout=subprocess.PIPE
        )
        result = p.stdout.read()
        self.assert_(
            check_expected(
        ...
        p = subprocess.Popen(
            [sys.executable, "-OO", "lex_optimize3.py"], stdout=subprocess.PIPE
        )
        result = p.stdout.read()
        self.assert_(
            check_expected(
    ...
    def test_lex_opt_alias(self):
        ...
        p = subprocess.Popen(
            [sys.executable, "-O", "lex_opt_alias.py"], stdout=subprocess.PIPE
        )
        result = p.stdout.read()
        self.assert_(
            check_expected(
        ...
        p = subprocess.Popen(
            [sys.executable, "-OO", "lex_opt_alias.py"], stdout=subprocess.PIPE
        )
        result = p.stdout.read()
        self.assert_(
            check_expected(
    ...
    def test_lex_many_tokens(self):
        ...
        if implementation() == "CPython":
            p = subprocess.Popen(
                [sys.executable, "-O", "lex_many_tokens.py"],
